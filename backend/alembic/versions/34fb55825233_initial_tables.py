...
Revision ID: 34fb55825233
Revises: 
Create Date: 2026-04-09 20:15:37.789945
...
def upgrade() -> None:
    ...
    sa.Column('reply_content', sa.Text(), nullable=True, comment='博主回复'),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False, comment='主键ID'),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='创建时间'),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='更新时间'),
    sa.Column('deleted_at', sa.DateTime(), nullable=True, comment='删除时间（软删除）'),
    ...
    sa.Column('password', sa.String(length=255), nullable=False, comment='哈希密码'),
    sa.Column('role', sa.Enum('ADMIN', 'COMMON', name='userrole'), server_default='common', nullable=False, comment='角色'),
    sa.Column('login_attempts', sa.Integer(), server_default='0', nullable=False, comment='失败次数'),
    sa.Column('last_fail_time', sa.DateTime(), nullable=True, comment='最后失败时间'),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False, comment='主键ID'),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='创建时间'),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='更新时间'),
    sa.Column('deleted_at', sa.DateTime(), nullable=True, comment='删除时间（软删除）'),
    ...
    sa.Column('summary', sa.String(length=500), nullable=False, comment='摘要'),
    sa.Column('content', sa.Text(length=4294967295), nullable=False, comment='源码'),
    sa.Column('html_content', sa.Text(length=4294967295), nullable=False, comment='渲染HTML'),
    sa.Column('editor_type', sa.Enum('MARKDOWN', 'RICHTEXT', name='editortype'), server_default='markdown', nullable=False, comment='编辑器类型'),
    sa.Column('status', sa.Enum('PUBLISHED', 'DRAFT', name='articlestatus'), server_default='draft', nullable=False, comment='状态'),
    sa.Column('cover_image', sa.String(length=255), nullable=True),
    sa.Column('view_count', sa.Integer(), server_default='0', nullable=False, comment='阅读量'),
    ...
    sa.Column('email', sa.String(length=100), nullable=False, comment='邮箱'),
    sa.Column('is_audited', sa.Boolean(), server_default='0', nullable=False, comment='审核状态'),
    sa.Column('article_id', sa.Integer(), nullable=False),
